...
export class CanvasShapeElement extends CustomElement {
    constructor() {
        super({
            isTemplate: true,
            isHidden: true,
    ...
    GetFigureChildren() {
        return FilterByFunction(Array.from(this.children), 'GetFigureChildren');
    }
    GetPosition() {
    ...
    GetContext() {
        var _a;
        return (((_a = FindAncestorByFunction(this, 'GetContext')) === null || _a === void 0 ? void 0 : _a.GetContext()) || null);
    }
    GetSurfaceContext() {
        var _a;
        return (((_a = FindAncestorByFunction(this, 'GetSurfaceContext')) === null || _a === void 0 ? void 0 : _a.GetSurfaceContext()) || null);
    }
    GetSurfaceSize() {
        var _a;
        return (((_a = FindAncestorByFunction(this, 'GetSurfaceSize')) === null || _a === void 0 ? void 0 : _a.GetSurfaceSize()) || { width: 0, height: 0 });
    }
    GetSize(ctx) {
    ...
    GetTransformScale() {
        var _a;
        return (((_a = FindAncestorByFunction(this, 'GetTransformScale')) === null || _a === void 0 ? void 0 : _a.GetTransformScale()) || { horizontal: 1, vertical: 1 });
    }
    GetPriority() {
        return this.priority;
    }
    GetShapeChildren() {
        return FilterByFunction(Array.from(this.children), 'GetShapeChildren');
    }
    Refresh() {
        this.Refresh_();
    }
    ...
    Refresh_() {
        var _a;
        (_a = FindAncestorByFunction(this, 'Refresh')) === null || _a === void 0 ? void 0 : _a.Refresh();
    }
    GetOffsetPosition_(ctx) {
        const ancestor = FindAncestorByFunction(this, 'OffsetPosition');
    ...
    GetParentSize_(ctx) {
        const ancestor = FindAncestorByFunction(this, 'GetFixedSize');
