...
import { CheckCircleCollision, CheckRectangleCircleCollision, CheckRectangleCollision, GetIntersectionRectangle } from "../utilities/shape-collision";
/**
...
export class CanvasBodyElement extends CanvasParentElement {
    ...
    Step_(dispatch = true) {
        ...
        if (!this.phase) {
            ...
            const collisionSides = new Array(), addCollisionSide = (side) => {
...
__decorate([
    Property({ type: 'string' })
], CanvasBodyElement.prototype, "oncustomcollision", void 0);
__decorate([
    Property({ type: 'string' })
], CanvasBodyElement.prototype, "oncustomphase", void 0);
/**
