...
class CanvasSurface extends inlinejs_element_1.CustomElement {
    constructor() {
        ...
        if (!this.hasAttribute('size')) {
            (0, inlinejs_element_1.SetValue)(this.state_['size'], 'width', (this.getAttribute('width') || '0'));
            (0, inlinejs_element_1.SetValue)(this.state_['size'], 'height', (this.getAttribute('height') || '0'));
        }
        else { //Initialize with size attribute
            (0, inlinejs_element_1.SetValue)(this.state_, 'size', (this.getAttribute('size') || '0'));
        }
        (_a = this.shadow_) === null || _a === void 0 ? void 0 : _a.setAttribute('width', (0, inlinejs_1.ToString)(this.state_['size']['width']));
        (_b = this.shadow_) === null || _b === void 0 ? void 0 : _b.setAttribute('height', (0, inlinejs_1.ToString)(this.state_['size']['height']));
        this.addEventListener(types_1.CanvasRefreshEvent, () => this.Refresh());
    ...
    Render_() {
        ...
        this.rendered_ = true;
        this.ctx_.save();
        Array.from(this.children).filter(child => (typeof child['Paint'] === 'function')).forEach(child => (0, inlinejs_1.JournalTry)(() => child['Paint'](this.ctx_), 'Canvas.Render'));
        this.ctx_.restore();
    }
    FindWithMouse_() {
...
function CanvasSurfaceCompact() {
    customElements.define((0, inlinejs_1.GetGlobal)().GetConfig().GetElementName('canvas'), CanvasSurface);
}
