...
exports.CanvasSurfaceCompact = exports.CanvasSurfaceElement = void 0;
const inlinejs_1 = require("@benbraide/inlinejs");
const inlinejs_element_1 = require("@benbraide/inlinejs-element");
const filter_1 = require("../utilities/filter");
const context_1 = require("../utilities/context");
class CanvasSurfaceElement extends inlinejs_element_1.CustomElement {
    constructor() {
        super();
        this.shadow_ = null;
        this.ctx_ = null;
    ...
    RenderCallback_() {
        ...
        this.rendered_ = true;
        (0, context_1.GuardContext)(this.ctx_, (ctx) => {
            if (this.priorityAware) {
                const inPriority = {};
                (0, filter_1.FilterByFunction)(Array.from(this.children), 'GetPriority').forEach((child) => {
                ...
                Object.keys(inPriority).sort().forEach((priority) => {
                    (0, filter_1.FilterByFunction)(inPriority[priority], 'Paint').forEach(child => (0, inlinejs_1.JournalTry)(() => child.Paint(ctx), 'Canvas.Render'));
                });
            }
            else {
                (0, filter_1.FilterByFunction)(Array.from(this.children), 'Paint').forEach(child => (0, inlinejs_1.JournalTry)(() => child.Paint(ctx), 'Canvas.Render'));
            }
        });
    }
    FindWithMouse_() {
        ...
        for (let child of (0, filter_1.FilterByFunction)(Array.from(this.children), 'FindFigureWithPoint')) {
...
exports.CanvasSurfaceElement = CanvasSurfaceElement;
function CanvasSurfaceCompact() {
    (0, inlinejs_element_1.RegisterCustomElement)(CanvasSurfaceElement, 'canvas');
}
