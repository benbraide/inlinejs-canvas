...
exports.CanvasRelativeCompact = exports.CanvasRelativeElement = void 0;
const inlinejs_element_1 = require("@benbraide/inlinejs-element");
const parent_1 = require("./parent");
const shape_1 = require("./shape");
class CanvasRelativeElement extends parent_1.CanvasParentElement {
    constructor() {
        super(...arguments);
        this.direction = 'row';
    }
    ...
    ApplyOffset_(position, ctx) {
        ...
        for (const child of this.parentElement.children) {
            ...
            if (child instanceof shape_1.CanvasShapeElement) {
                previous = child;
            }
        }
...
exports.CanvasRelativeElement = CanvasRelativeElement;
function CanvasRelativeCompact() {
    (0, inlinejs_element_1.RegisterCustomElement)(CanvasRelativeElement, 'canvas-relative');
}
exports.CanvasRelativeCompact = CanvasRelativeCompact;
