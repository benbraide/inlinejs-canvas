...
exports.CanvasRoundRectCompact = exports.CanvasRoundRectElement = void 0;
const inlinejs_element_1 = require("@benbraide/inlinejs-element");
const path_1 = require("./path");
class CanvasRoundRectElement extends path_1.CanvasPathElement {
    constructor() {
        super();
        this.width = 0;
        this.height = 0;
...
exports.CanvasRoundRectElement = CanvasRoundRectElement;
function CanvasRoundRectCompact() {
    (0, inlinejs_element_1.RegisterCustomElement)(CanvasRoundRectElement, 'canvas-round-rect');
}
