...
exports.CanvasEllipseCompact = exports.CanvasEllipse = void 0;
const inlinejs_1 = require("@benbraide/inlinejs");
const path_1 = require("./path");
class CanvasEllipse extends path_1.CanvasPath {
    constructor() {
        super({
            radius: {
                'radius-x': 0,
...
exports.CanvasEllipse = CanvasEllipse;
function CanvasEllipseCompact() {
    customElements.define((0, inlinejs_1.GetGlobal)().GetConfig().GetElementName('canvas-ellipse'), CanvasEllipse);
}
