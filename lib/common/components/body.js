...
exports.CanvasBodyCompact = exports.CanvasBody = void 0;
const inlinejs_1 = require("@benbraide/inlinejs");
const types_1 = require("../types");
const parent_1 = require("./parent");
class CanvasBody extends parent_1.CanvasParent {
    constructor() {
        super({
            direction: '',
            orientation: 'none',
        ...
        this.direction_ = '';
        window.addEventListener(types_1.CanvasCollisionCheckEvent, (e) => {
            if (e.detail.source && 'CheckCollision_' in e.detail.source && e.detail.source !== this) {
                this.CheckCollision_(e.detail.source);
            }
        });
        this.addEventListener(types_1.CanvasCollisionEvent, (e) => {
    ...
    DispatchEvent_() {
        ...
        queueMicrotask(() => {
            this.dispatching_ = false;
            window.dispatchEvent(new CustomEvent(types_1.CanvasCollisionCheckEvent, {
                detail: { source: this },
            }));
        });
    }
    CheckCollision_(source) {
        ...
        source.dispatchEvent(new CustomEvent(types_1.CanvasCollisionEvent, {
            detail: { target: this },
        }));
        this.dispatchEvent(new CustomEvent(types_1.CanvasCollisionEvent, {
...
exports.CanvasBody = CanvasBody;
function CanvasBodyCompact() {
    customElements.define((0, inlinejs_1.GetGlobal)().GetConfig().GetElementName('canvas-body'), CanvasBody);
}
