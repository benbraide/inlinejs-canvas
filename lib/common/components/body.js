...
class CanvasBodyElement extends parent_1.CanvasParentElement {
    ...
    HandleCollision_(source) {
        ...
        const intersection = (0, shape_collision_1.GetIntersectionRectangle)(thisCollisionRect, sourceCollisionRect);
        if (intersection) {
            this.InvertDirection_((0, shape_collision_1.GetIntersectionDirection)(intersection, thisCollisionRect));
            source.InvertDirection_((0, shape_collision_1.GetIntersectionDirection)(intersection, sourceCollisionRect));
        }
    }
    InvertDirection_(collisionDirection, dispatchEvent = true) {
        ...
        dispatchEvent && (0, inlinejs_1.EvaluateLater)({
