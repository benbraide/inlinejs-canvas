...
exports.CanvasTextCompact = exports.CanvasText = void 0;
...
class CanvasText extends full_shape_1.CanvasFullShape {
    constructor() {
        super({
...
function CanvasTextCompact() {
    (0, inlinejs_1.GetGlobal)().GetConfig().AddBooleanAttribute('cache');
    customElements.define((0, inlinejs_1.GetGlobal)().GetConfig().GetElementName('canvas-text'), CanvasText);
}
